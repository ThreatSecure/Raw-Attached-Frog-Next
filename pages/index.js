  ...
  return (
    <>
      <div className="home-container">
        <Head>
          <title>Raw Attached Frog</title>
          <meta property="og:title" content="Raw Attached Frog" />
        </Head>
              ...
              <div className="home-container02">
                ...
                <span className="home-features-sub-heading bodyLarge">
                  <span>
                    <span>
                      <span>
                        Unlock the full potential of your information security
                        and data protection
                      </span>
                      <span>
                        <span
          ...
          <div className="home-pricing1 pricingContainer">
            <div className="home-container04">
              ...
              <span className="home-pricing-sub-heading bodyLarge">
                <span>
                  <span>
                    Select from our range of plans to get the best information
                    security and data protection consultation
                  </span>
                </span>
              </span>
            </div>
            <div className="home-container05">
              <div className="freePricingCard home-pricing-card">
                <div className="home-container06">
                  ...
                  <span className="bodySmall">
                    A free plan for basic information security and data
                ...
                <div className="home-container08">
                  <div className="home-container09">
                    ...
                    <span className="bodySmall">
                      Limited access to information security compliance
                      consultation
                    </span>
                  </div>
                  <div className="home-container10">
                    ...
                    <span className="bodySmall">
                      Basic vulnerability assessment and penetration testing
                      (VAPT)
                    </span>
                  </div>
                  <div className="home-container11">
                    ...
                    <span className="bodySmall">
                      Limited data protection and privacy consultation
                    </span>
                  </div>
                  <div className="home-container12">
                    <span className="home-text43">✔</span>
                    <span className="bodySmall">No red team exercises</span>
                  </div>
                </div>
              ...
              <div className="basicPricingCard home-pricing-card1">
                <div className="home-container13">
                  ...
                  <span className="bodySmall">
                    A basic plan for comprehensive information security and data
                    protection consultation
                  </span>
                </div>
                ...
                <div className="home-container15">
                  ...
                  <div className="home-container17">
                    ...
                    <span className="bodySmall">
                      Access to information security compliance consultation
                    </span>
                  </div>
                  <div className="home-container18">
                    <span className="home-text52">✔</span>
                    <span className="bodySmall">
                      Comprehensive vulnerability assessment and penetration
                      testing (VAPT)
                    </span>
                  </div>
                  <div className="home-container19">
                    ...
                    <span className="bodySmall">
                      Data protection and privacy consultation
                    </span>
                  </div>
              ...
              <div className="proPricingCard home-pricing-card2">
                <div className="home-container21">
                  ...
                  <span className="bodySmall">
                    An advanced plan for advanced information security and data
                    protection consultation
                  </span>
                </div>
                ...
                <div className="home-container23">
                  ...
                  <div className="home-container28">
                    ...
                    <span className="bodySmall">Red team exercises</span>
                  </div>
                </div>
          ...
          <div className="home-banner1 bannerContainer">
            ...
            <span className="home-banner-sub-heading bodySmall">
              <span>
                <span>
                  <span>
                    We specialize in providing top-notch Information Security
                    Compliance Consultation, Vulnerability Assessment and
                    Penetration Testing (VAPT), Red team exercises, and data
                    protection and privacy consultation to our clients. With our
                    expertise and experience, we help organizations safeguard
                    their sensitive data and ensure compliance with industry
                    regulations.
                  </span>
                  <span>
                    <span
          ...
          <div className="faqContainer">
            <div className="home-faq1">
              ...
              <div className="home-container30">
                <Question1
                  Answer="Our consulting firm offers Information Security Compliance Consultation, VAPT, Red team exercises, and data protection and privacy consultation."
                  Question="What services does your consulting firm offer?"
                ></Question1>
                <Question1
                  Answer="VAPT stands for Vulnerability Assessment and Penetration Testing. It is a process of identifying vulnerabilities in a system or network and simulating real-world attacks to evaluate its security."
                  Question="What is VAPT?"
                ></Question1>
                <Question1
                  Answer="Red team exercises involve simulating real-world cyber attacks on an organization's systems to identify vulnerabilities and test the effectiveness of their security measures."
                  Question="What are Red team exercises?"
                ></Question1>
                <Question1
                  Answer="Information security compliance ensures that organizations adhere to industry regulations and standards to protect sensitive data, mitigate risks, and maintain customer trust."
                  Question="Why is information security compliance important?"
                ></Question1>
                <Question1
                  Answer="Data protection and privacy consultation involves helping organizations develop strategies and policies to safeguard sensitive data, comply with privacy regulations, and ensure the privacy rights of individuals."
                  Question="What is data protection and privacy consultation?"
                ></Question1>
              </div>
            </div>
          </div>
